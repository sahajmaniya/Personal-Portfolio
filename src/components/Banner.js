...
import headerImg from "../assets/img/ProfileImg3.jpg";
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
               ...
               <a target="_blank" href="https://drive.google.com/file/d/1nuzTNheKvj_0XI65LBQiBgEOb_KiMDIS/view?usp=sharing"  style={{textDecoration:"none"}} > <button >My Resume<ArrowRightCircle size={25} /></button></a>
              </div>} 
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
